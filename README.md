...
Отклонённый самим Mattermost токен или логин — окончательный отказ: до первого подключения `stream` сразу
завершается с ошибкой, после — печатает `failed` и завершается с ненулевым
