...
все посты. Правки и удаления проходят вслед за своим постом. Строки выходят
...
номера). Обрыв определяется и по отсутствию ответа на ping. Отклонённый
токен или логин — окончательный отказ: до первого подключения `stream` сразу
